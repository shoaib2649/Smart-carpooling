  ...
  <section class="h-100">
    <div class="container h-400">
      <div class="row justify-content-sm-center h-100">
        <div class="col-xxl-6 col-xl-6 col-lg-5 col-md-7 col-sm-9">
          <div class="text-center my-5">
            <img src="{{asset('customfile/images/logo.png')}}" alt="logo" width="150" class="rounded-circle img-thumbnail">
          </div>
          <div class="card shadow-lg">
            <div class="card-body p-5">
              <h1 class="fs-4 card-title fw-bold mb-4">Passenger Registration</h1>
              <form method="POST"  action="{{url('/passengerstore')}}">
                 @csrf
                <div class="mb-3">
